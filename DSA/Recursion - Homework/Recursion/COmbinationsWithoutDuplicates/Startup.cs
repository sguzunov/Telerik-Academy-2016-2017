// Write a recursive program for generating and printing all the combinations WITHOUT duplicatesof k elements from n-element set.
    ...
    public class Startup
    {
        ...
        private static void GenerateCombinationsWithDuplicates(int index, int start, int k, int n, int[] combinations)
        {
            ...
            for (int i = start; i <= n; i++)
            {
                ...
                GenerateCombinationsWithDuplicates(index + 1, i + 1, k, n, combinations);
            }
        }
    }
}
